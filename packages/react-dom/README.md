...
安装 jest jest-config jest-environment-jsdom
...
来源自 ReactElement-test.js，直接复制下面的代码到同名文件：
...
这一行代码会报错，因为没有JSX解析能力，所以为jest增加JSX解析能力，安装Babel：pnpm i -D -w @babel/core @babel/preset-env @babel/plugin-transform-react-jsx
